...
C
      INTEGER SA,SB,SC
      CHARACTER(*), PARAMETER :: input  = "../DATA/input"
      CHARACTER(*), PARAMETER :: output = "../OUT/output"
...
c      PRINT '('' INPUT CONTROL FILE NAME (eq. Cochin_2012_tira.ctl )'')'
c      READ(*,*)input
c      PRINT '('' OUTPUT FILE NAME (eq. Cochin_2012_tira.pri )'')'
c      READ(*,*)output
